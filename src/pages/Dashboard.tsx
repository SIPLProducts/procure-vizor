  ...
  return (
    <MainLayout title="Executive Dashboard" subtitle="Real-time procurement insights">
      <div className="space-y-8 animate-fade-in">
        {/* Welcome Banner */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 p-8 text-white shadow-xl shadow-emerald-500/20">
